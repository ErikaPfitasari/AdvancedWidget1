package com.example.erika_moklet.advancedwidget1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout llMain = (LinearLayout) findViewById(R.id.linearLayoutMain);LinearLayout llMain = (LinearLayout) findViewById(R.id.linearLayoutMain);
